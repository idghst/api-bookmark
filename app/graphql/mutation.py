...
class Mutation:
    ...
    async def reorder_folders(
        ...
        await resolve(bookmarks.reorder_folders(positions(input), info.context.auth))
        return True
    ...
    async def delete_section(
        ...
        await resolve(bookmarks.delete_section(id, info.context.auth))
        return True
    ...
    async def reorder_sections(
        ...
        await resolve(bookmarks.reorder_sections(positions(input), info.context.auth))
        return True
